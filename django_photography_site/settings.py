"""
Django settings for django_photography_site project.
...
SECRET_KEY = 'j6w=*ek5do9rm9-*c33_)19g%+%4*+a&h&)x=_@v#l+6q3$p!i'
...
ROOT_URLCONF = 'django_photography_site.urls'
...
WSGI_APPLICATION = 'django_photography_site.wsgi.application'
